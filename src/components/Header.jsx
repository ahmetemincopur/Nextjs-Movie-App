...
const Header = () => {
    return (
        <nav className="w-full sticky top-0 z-50 dark:bg-transparent bg-transparent 
    text-base md:text-base lg:text-lg xl:text-xl 
    sm:top-0 md:top-0 lg:top-1 xl:top-2">
            <div className="container mx-auto w-full px-4 rounded-xl shadow-lg bg-white dark:bg-slate-800
        sm:w-full
        md:w-full
        lg:my-2 lg:w-[80%]
        xl:my-2.5 xl:w-[80%]">
                <div className="flex justify-between items-center py-2 dark:text-white
            md:py-2
            lg:py-3
            xl:py-3">
                    <a className="font-bold text-gray-800 dark:text-white" href="/">Movie App</a>
                    ...
                    md:visible lg:visible dark:text-white" href="/">Home</a>
                        <a className="font-bold text-gray-800 invisible px-4 border-b-4 border-t-4 hover:border-b-black border-transparent
                    md:visible lg:visible dark:text-white" href="/about">About</a>
                        <ThemeSwitch />
                    </div>
